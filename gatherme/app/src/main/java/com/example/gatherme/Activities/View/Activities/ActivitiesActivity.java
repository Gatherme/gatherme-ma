package com.example.gatherme.Activities.View.Activities;
...
import com.example.gatherme.Tinder.View.Activities.Card;
import com.example.gatherme.Tinder.View.Activities.arrayAdapter;
...
public class TinderActivity extends AppCompatActivity {
    ...
    private com.example.gatherme.Tinder.View.Activities.arrayAdapter arrayAdapter;
    List<com.example.gatherme.Tinder.View.Activities.Card> rowItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onRightCardExit(Object dataObject) {
                ...
                enviarSolicitudAmistad((com.example.gatherme.Tinder.View.Activities.Card) dataObject);
    ...
    public void enviarSolicitudAmistad (com.example.gatherme.Tinder.View.Activities.Card card){
    ...
    public List<com.example.gatherme.Tinder.View.Activities.Card> sugerenciasCards (){
        // se crea arroy de cards para sugerencias
        rowItems = new ArrayList<com.example.gatherme.Tinder.View.Activities.Card>();
        com.example.gatherme.Tinder.View.Activities.Card item = new com.example.gatherme.Tinder.View.Activities.Card("", "", "", "");
        rowItems.add(item);
                                ...
                                viewModel.userByUsername(new ApolloCall.Callback<UserByUsernameQuery.Data>() {
                                    ...
                                    public void onResponse(@NotNull Response<UserByUsernameQuery.Data> response) {
                                        if(response.getData() == null){
                                            ...
                                            com.example.gatherme.Tinder.View.Activities.Card item = new Card(nombre, ubicacion, biografia, nick);
                                            rowItems.add(item);
                                        }
                                    }
